...
public class Node {
    ...
    private Node(int[][] board, int r, int c, int depth, Direction d, Node n){
        // non-root state transition. the node is being generated by its parent n taken direction d
        this.r = r;
        this.c = c;
        this.board = board;
        this.adj = new ArrayList<>();

        // find all possible direction with previous direction taken into account
